<ul class="navbar-nav navbar-nav-lg nav-tabs">
    ...
    <li class="nav-item ">
        <a class="js-nav-tooltip-link nav-link " href="{{ route('customer.dashboard.index') }}" title="Layouts"
            data-placement="left">
    ...
    <li class="nav-item">
        <small class="nav-subtitle" title="Layouts">My Inventories</small>
        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
    </li>
    <li class="nav-item ">
        <a class="js-nav-tooltip-link nav-link " href="{{ route('customer.inventory.index') }}" title="Layouts"
            data-placement="left">
            <i class="tio-dashboard nav-icon"></i>
            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Inventories</span>
        </a>
    </li>
    <li class="nav-item">
        <small class="nav-subtitle" title="Layouts">My Refunds</small>
        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
    </li>
    <li class="nav-item ">
        <a class="js-nav-tooltip-link nav-link " href="{{ route('customer.refund.index') }}" title="Layouts"
            data-placement="left">
            <i class="tio-dashboard nav-icon"></i>
